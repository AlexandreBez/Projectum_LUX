...
public class StopwatchPanel extends JPanel {
    ...
    public StopwatchPanel() {
        ...
        // Configura o estado inicial do botão de reset
    ...
    public void start() {
        if (!isRunning) {
            ...
            // Desabilita o botão de reset enquanto o cronômetro está rodando
            resetButton.setEnabled(false);
        }
    }
    ...
    public void stop() {
        if (isRunning) {
            ...
            // Habilita o botão de reset quando o cronômetro parar
    ...
    public void reset() {
        ...
        // Desabilita o botão de reset novamente até que o cronômetro seja iniciado
        resetButton.setEnabled(false);
    }
}
